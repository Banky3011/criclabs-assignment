...
const Drawer = (props: DrawerProps) => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 right-0 md:ml-[256px] mt-16 lg:mt-0 md:mt-0 h-full rounded-t-xl lg:rounded-none w-full sm:w-96 bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-[60] ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
